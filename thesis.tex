...
\usepackage[pdfusetitle, unicode, linkbordercolor=fhorange, citebordercolor=fhorange]{hyperref}
\usepackage{bookmark}
...
\titlehead{\includegraphics[height=2cm]{logos/fh-logo.pdf}}
